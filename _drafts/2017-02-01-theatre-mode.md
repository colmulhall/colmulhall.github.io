...
While it's definitely a nice feature, even if a little bit too niche [2], I hope that it isn't Apples only attempt at a dark mode this year. I've long been anticipating a system wide dark mode on iOS, and Theatre Mode seems like a logical step towards it. 

I don't expect dark mode to show up in any of the iOS 10.3 builds over the newxt few weeks. If it's to be introduced this year it will presumably be with iOS 11. 
